...
export default function Hero({
  ...
  return (
    <section className="relative h-screen min-h-[680px] max-h-[900px] overflow-hidden bg-dark">
      ...
      {/* Content */}
      <div className="relative h-full flex flex-col justify-end px-10 pb-20 lg:px-16 lg:pb-24">
        <div className="max-w-[760px]">
          <h1 className="font-serif font-light text-gold text-[clamp(56px,8.3vw,120px)] leading-[1.0] tracking-[-0.01em] mb-8">
            {headline}
          </h1>

          <p className="font-nav text-gold/90 text-[18px] leading-[1.4] mb-10 max-w-[448px]">
            {subtext}
          </p>
