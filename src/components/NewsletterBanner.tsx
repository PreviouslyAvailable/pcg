...
export default function NewsletterBanner() {
  return (
    <div className="bg-teal rounded-[16px] px-8 py-12 lg:px-16 lg:py-14 text-center">
      ...
      <NewsletterForm
        className="max-w-[420px] mx-auto text-left"
        inputClassName="w-full bg-white/20 border border-white/30 rounded-[8px] px-4 py-3 font-nav text-[15px] text-white placeholder:text-white/50 outline-none focus:border-white/60 transition-colors disabled:opacity-60"
        buttonClassName="w-full bg-white text-teal font-sans text-[14px] uppercase px-6 py-3 rounded-[8px] hover:bg-white/90 transition-colors disabled:opacity-60"
        hintClassName="font-nav text-[13px] text-white/60"
        onTeal
