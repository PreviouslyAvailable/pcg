...
export default function NewsletterBanner() {
  return (
    <div className="bg-teal rounded-[16px] px-8 py-12 lg:px-16 lg:py-14 text-center">
      ...
      <NewsletterForm
        className="flex flex-col gap-2 max-w-[420px] mx-auto text-left"
        inputClassName="w-full sm:flex-1 bg-white/20 border border-white/30 rounded-[8px] px-4 py-3 font-nav text-[15px] text-white placeholder:text-white/50 outline-none focus:border-white/60 transition-colors disabled:opacity-60"
