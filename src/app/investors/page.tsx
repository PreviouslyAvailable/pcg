    ...
    <main className="bg-cream">
      ...
      <section className="px-4 lg:px-[60px] py-16 lg:py-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-16 gap-y-10 mb-10">
          <div>
            <h3 className="font-sans text-ink text-[20px] leading-[1.2] mb-3">Defensive Yield with Inflation Protection</h3>
          ...
          <div>
            <h3 className="font-sans text-ink text-[20px] leading-[1.2] mb-3">Granular Exposure to the NZ Middle Market</h3>
            <p className="font-nav text-ink text-[16px] leading-[1.5]">
        ...
        <div className="border-t border-black/10 pt-10">
          <h3 className="font-sans text-ink text-[20px] leading-[1.2] mb-3">Capital Preservation via Structural Protection</h3>
          <p className="font-nav text-ink text-[16px] leading-[1.5] max-w-[680px]">
      ...
      <section className="px-4 lg:px-[60px] pb-16 lg:pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-cream-warm rounded-[18px] p-8 flex flex-col">
            <h3 className="font-sans text-ink text-[20px] leading-[1.2] mb-6">
            ...
            <div className="flex-1 divide-y divide-black/10 mb-8">
              {fundDetails.map((row) => (
                <div key={row.label} className="flex gap-4 py-3">
                  ...
                  <p className="font-nav text-ink text-[14px] leading-[1.4]">{row.value}</p>
                </div>
              ))}
            </div>
            <Link
          ...
          <div className="bg-dark rounded-[18px] p-8 flex flex-col">
            <h3 className="font-sans text-white text-[20px] leading-[1.2] mb-6">
              Another Fund
            </h3>
            <div className="flex-1 divide-y divide-white/10 mb-8">
              {fundDetails.map((row) => (
                <div key={row.label} className="flex gap-4 py-3">
                  ...
                  <p className="font-nav text-white/80 text-[14px] leading-[1.4]">{row.value}</p>
                </div>
              ))}
            </div>
            <Link
      ...
      <section className="px-4 lg:px-[60px] pb-16 lg:pb-24">
        <div className="bg-teal rounded-[18px] p-8 lg:p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-10">
            <div>
              <h3 className="font-sans text-white text-[18px] mb-3">NZTE Acceptable Managed Fund Status</h3>
              <p className="font-nav text-white/80 text-[15px] leading-[1.5]">
            ...
            <div>
              <h3 className="font-sans text-white text-[18px] mb-3">Proven Track Record</h3>
              <p className="font-nav text-white/80 text-[15px] leading-[1.5]">
          ...
          <div className="border-t border-white/20 pt-8 mb-10">
            <h3 className="font-sans text-white text-[18px] mb-3">Global Tax Readiness</h3>
            <p className="font-nav text-white/80 text-[15px] leading-[1.5] max-w-[680px]">
